    ...
    <div class="main_block">
        ...
        <div class="body_content">
            ...
            <div class="form_block">
                <h1 class="main_heading">Books Requests List</h1>          
                <div id="return_msg"></div><br>
            <?php
                if( isset($_GET['req_sent']) && !empty($_GET['req_sent']) ) {
                    echo '<div class="success_msg">Borrowed book has returned successfully!</div>';
                }
            ?>
                <div class="books_block">
                    <table class="record_view_table">
                        ...
                        <?php echo $mb->bookrecords->student_book_request_lists(); ?>
                    </table>
                </div>
            </div>
                </div>
