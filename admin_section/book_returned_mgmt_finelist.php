    ...
    <div class="main_block">
        ...
        <div class="body_content">
            ...
            <div class="form_block">
                <h1 class="main_heading">Fine Students</h1>  <br><br>     
                <div id="return_msg">List of books that is not returned by the students</div><br>
            <?php
            ...
            ?>
                <div class="books_block">
                    <table class="record_view_table">
                        ...
                        <?php echo $book->book_fine_mgmt_list(); ?>
                    </table>
                </div>
            </div>
                </div>
