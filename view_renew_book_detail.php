...
$returned_link = SYSTEM_LINK . 'view_renew_book_detail.php?req_sent=sent&book_id=' . $book_id;

if( !empty($request_sent) ) {
    if( !empty($student_id) ) {
        $mb->send_book_request( $book_id,  $student_id, 'RN');
        header('Location:'.SYSTEM_LINK.'student_book_renewal_mgmt.php?req_sent=sent');
    } else {
            ...
            <div class="form_block">
                ...
                <div>
                    ...
                    <div class="form_row">
                        ...
                        <div class="form_field">
                            <b><?php echo d_format( $borrowed_book['returned_date'] ); /// common_function file ?></b>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="form_row">
                        ...
                        <div class="form_field">
                            <a href="<?php echo $returned_link; ?>" class="btn_style">Renew Book</a>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <br><br>
