...
$borrowed_book = $mb->bookrecords->borrowed_book_detail( $student_id, $book_id );
$book_cover = SYSTEM_LINK.'admin_section/'.$mb->bookrecords->book_cover_img( $row['book_cover'] );
$returned_link = SYSTEM_LINK . 'view_issued_book_detail.php?req_sent=sent&book_id=' . $book_id;

if( !empty($request_sent) ) {
    if( !empty($student_id) ) {
        $mb->send_book_request( $book_id,  $student_id, $request_sent, 'RNT'); /// RNT: Renew Return Book
        header('Location:'.SYSTEM_LINK.'student_book_request_list.php?req_sent=sent');
    } else {
        ...
        <div class="body_content">
            ...
            <div class="form_block">
                ...
                <div>
                    <?php 
                        if( !empty($request_sent) ) {
                            echo '<div class="success_msg">Borrowed book has returned successfully!</div><br>';
                        }
                    ?>                
                    <div class="form_row">
                    ...
                    <div class="form_row">
                        ...
                        <div class="form_field">
                            <a href="<?php echo SYSTEM_LINK.'admin_section/uploads/book_file/'.$row['book_file']; ?>" class="pageLink" target="_blank">Download Book</a>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="form_row">
                    ...
                    <div class="form_row">
                        ...
                        <div class="form_field">
                            <a href="<?php echo $returned_link; ?>" class="btn_style">Returned Book</a>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <br><br>
